...
export class Backend implements backendInterface {
    ...
    async addPriceEntry(arg0: bigint, arg1: string, arg2: number, arg3: boolean): Promise<PriceEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.addPriceEntry(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async createProduct(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async deletePriceEntry(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deletePriceEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAIInsight(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAIInsight(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPriceEntries(arg0: bigint): Promise<Array<PriceEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceEntries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePriceEntry(arg0: bigint, arg1: string, arg2: number, arg3: boolean): Promise<PriceEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePriceEntry(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<Product> {
        if (this.processError) {
            try {
